...
<?
	...
	if(!$pagenum || $pagenum < 0) $pagenum=0;
		...
		$query = "select count(*) from carinfo where direct='Y' ";
		...
		$query = "select * from carinfo where direct='Y' order by issale desc, idx desc limit $start,$page";
...
<div id="wrap">
	...
	<div class="content">
		...
		<div class="reg-box">
			...
			<div class="btnlist">
				<ul class="btn_bo_adm">
				<li><input type="submit" name="btn_submit" value="직거래차량취소" onclick="javascript:direct_cancel()"></li>
