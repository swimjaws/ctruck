...
<div id="wrap">
	...
	<div class="content">
		<table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
			<tr>
                <td>HOME > 차량관리 > <?php echo $dtitle;?> 차량 등록하기</td>
			</tr>
		</table>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
			    <td height="45"><div class="hetxt"><?php echo $dtitle;?> 차량 등록</div><a href="/adm/guide/guide1.html" target="top" style="float:right"><img src="/adm/image/guibtn.png"></a></td>
			</tr>
			<tr>
			    <td height="20"></td>
			</tr>
		...
		<!-- 등록-->
			...
			-->
				...
				<tr>
					<th>축</th>
					<td><input type="radio" name="shaft" value="단발이" checked> 단발이 &nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="shaft" value="앞축"> 앞축 &nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="shaft" value="후축"> 후축 &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="shaft" value="중축"> 중축 &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="shaft" value="2*3축"> 2*3축</td>
				</tr>
				<tr>
					<th>유튜브영상</th>
					<td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  <tr>
			    <td height="50" align="center"><a href="javascript:save()" class="reg-bti">차량등록</a></td>
			  </tr>
			</table>
			<!-- //등록-->
	</div>
