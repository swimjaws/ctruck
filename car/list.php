...
<?
	...
	//if($md) $strquery .= " and cartype='$cartype'";
	//if($me) $strquery .= " and carkind='$carkind'";
...
function direct()
{
	if ( ! checkedRadio($L("chk[]"), "차량을")) return;
		...
		var frm = document.frm;
			frm.action = "direct.php";
			frm.target = "iProc";
			frm.submit();
}

function direct_cancel()
{
	if ( ! checkedRadio($L("chk[]"), "차량을")) return;
	
		var frm = document.frm;
			frm.action = "direct_cancel.php";
			frm.target = "iProc";
			frm.submit();
}
...
function issale(idx,pagenum)
	...
	function recomm_page()
{
	var frm = document.frm;
		
		frm.action = "recomm_page.php";
		frm.target = "_self";
		frm.submit();
}
...
function changecar() {
	...
	var SelectIndex=ctype.selectedIndex;
	
	for(var i=0;i<ctype.length;i++){
		ctype.options[i].style.backgroundColor="#fff";
	}
	
	ctype.options[SelectIndex].style.backgroundColor="#fff";
...
<div id="wrap">
	...
	<div class="content">
		<table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
			<tr>
                <td>HOME > 차량관리 > 차량 리스트</td>
			</tr>
		</table>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
			    <td height="45"><div class="hetxt">차량 리스트</div><a href="/adm/guide/guide2.html" target="top" style="float:right"><img src="/adm/image/guibtn.png"></a></td>
			</tr>
		</table>
		<!-- 검색 -->
		<div class="reg-box">
			  ...
			  <?
			   ...
			   <tr> 
				...
				<td width="100" align="center">
					...
					<? if($rs[direct]=='Y') { ?><p style="padding-top:5px;"><img src="/adm/image/direct.gif"></p><? } ?>
				</td>
                <td width="100" align="center">
			...
			<div class="btnlist" style="padding-bottom:100px;">
				<ul class="btn_bo_adm">
					<!-- <li><input type="submit" name="btn_submit" value="날짜재등록" onclick="javascript:reup()"></li> -->
					...
					<li><input type="submit" name="btn_submit" value="직거래등록" onclick="javascript:direct()"></li>
					<!-- <li><input type="submit" name="btn_submit" value="직거래취소" onclick="javascript:direct_cancel()"></li> -->
